clc
clear all
syms C1 C2 C3 C4 C5 C6 C7 C8 x y; 
 %%%%%%values
 C=150;
 A=150;
 E=135 ;
...
eq4=(C2*am - C4*am + C1*bm + C3*bm + C5*cm + C7*dm - C8*dm) ;
%---------------p(x=c,y=0)=P
...
EQ4=m*cos(m*y)*(exp(am*c)*(C1*bm^5*cos(bm*c) - C2*bm^5*sin(bm*c)) + exp(-am*c)*(C3*bm^5*cos(bm*c) - C4*bm^5*sin(bm*c)) + 5*am^4*exp(am*c)*(C1*bm*cos(bm*c) - C2*bm*sin(bm*c)) + 5*am^4*exp(-am*c)*(C3*bm*cos(bm*c) - C4*bm*sin(bm*c)) + am^5*exp(am*c)*(C2*cos(bm*c) + C1*sin(bm*c)) - am^5*exp(-am*c)*(C4*cos(bm*c) + C3*sin(bm*c)) + 5*am*exp(am*c)*(C2*bm^4*cos(bm*c) + C1*bm^4*sin(bm*c)) - 5*am*exp(-am*c)*(C4*bm^4*cos(bm*c) + C3*bm^4*sin(bm*c)) + C5*cm^5*cos(c*cm) - 10*am^3*exp(am*c)*(C2*bm^2*cos(bm*c) + C1*bm^2*sin(bm*c)) - 10*am^2*exp(am*c)*(C1*bm^3*cos(bm*c) - C2*bm^3*sin(bm*c)) + 10*am^3*exp(-am*c)*(C4*bm^2*cos(bm*c) + C3*bm^2*sin(bm*c)) - 10*am^2*exp(-am*c)*(C3*bm^3*cos(bm*c) - C4*bm^3*sin(bm*c)) + C7*dm^5*exp(c*dm) - C8*dm^5*exp(-c*dm) - C6*cm^5*sin(c*cm)) ;
eq5 =((1+E)*EQ1-1*EQ2-C*EQ3+A*EQ4)   ;
%--------------p(x=c,y=0)=-P
EQ1=m*(exp(-am*c)*(C1*bm*cos(bm*c) + C2*bm*sin(bm*c)) + exp(am*c)*(C3*bm*cos(bm*c) + C4*bm*sin(bm*c)) + am*exp(-am*c)*(C2*cos(bm*c) - C1*sin(bm*c)) - am*exp(am*c)*(C4*cos(bm*c) - C3*sin(bm*c)) + C5*cm*cos(c*cm) + C7*dm*exp(-c*dm) - C8*dm*exp(c*dm) + C6*cm*sin(c*cm)) ;
EQ2=m*(exp(-am*c)*(C1*bm*cos(bm*c) + C2*bm*sin(bm*c)) + exp(am*c)*(C3*bm*cos(bm*c) + C4*bm*sin(bm*c)) + am*exp(-am*c)*(C2*cos(bm*c) - C1*sin(bm*c)) - am*exp(am*c)*(C4*cos(bm*c) - C3*sin(bm*c)) + C5*cm*cos(c*cm) + C7*dm*exp(-c*dm) - C8*dm*exp(c*dm) + C6*cm*sin(c*cm)) ;
EQ3=-m*(exp(-am*c)*(C1*bm^3*cos(bm*c) + C2*bm^3*sin(bm*c)) + exp(am*c)*(C3*bm^3*cos(bm*c) + C4*bm^3*sin(bm*c)) - 3*am^2*exp(-am*c)*(C1*bm*cos(bm*c) + C2*bm*sin(bm*c)) - 3*am^2*exp(am*c)*(C3*bm*cos(bm*c) + C4*bm*sin(bm*c)) - am^3*exp(-am*c)*(C2*cos(bm*c) - C1*sin(bm*c)) + am^3*exp(am*c)*(C4*cos(bm*c) - C3*sin(bm*c)) + 3*am*exp(-am*c)*(C2*bm^2*cos(bm*c) - C1*bm^2*sin(bm*c)) - 3*am*exp(am*c)*(C4*bm^2*cos(bm*c) - C3*bm^2*sin(bm*c)) + C5*cm^3*cos(c*cm) - C7*dm^3*exp(-c*dm) + C8*dm^3*exp(c*dm) + C6*cm^3*sin(c*cm)) ;
EQ4=m*cos(m*y)*(exp(am*c)*(C1*bm^5*cos(bm*c) - C2*bm^5*sin(bm*c)) + exp(-am*c)*(C3*bm^5*cos(bm*c) - C4*bm^5*sin(bm*c)) + 5*am^4*exp(am*c)*(C1*bm*cos(bm*c) - C2*bm*sin(bm*c)) + 5*am^4*exp(-am*c)*(C3*bm*cos(bm*c) - C4*bm*sin(bm*c)) + am^5*exp(am*c)*(C2*cos(bm*c) + C1*sin(bm*c)) - am^5*exp(-am*c)*(C4*cos(bm*c) + C3*sin(bm*c)) + 5*am*exp(am*c)*(C2*bm^4*cos(bm*c) + C1*bm^4*sin(bm*c)) - 5*am*exp(-am*c)*(C4*bm^4*cos(bm*c) + C3*bm^4*sin(bm*c)) + C5*cm^5*cos(c*cm) - 10*am^3*exp(am*c)*(C2*bm^2*cos(bm*c) + C1*bm^2*sin(bm*c)) - 10*am^2*exp(am*c)*(C1*bm^3*cos(bm*c) - C2*bm^3*sin(bm*c)) + 10*am^3*exp(-am*c)*(C4*bm^2*cos(bm*c) + C3*bm^2*sin(bm*c)) - 10*am^2*exp(-am*c)*(C3*bm^3*cos(bm*c) - C4*bm^3*sin(bm*c)) + C7*dm^5*exp(c*dm) - C8*dm^5*exp(-c*dm) - C6*cm^5*sin(c*cm)) ;
eq6 =((1+E)*EQ1-1*EQ2-C*EQ3+A*EQ4)   ;
%---------------dU2/dx = 0 (x=0,y=d)
...
%---------------
%%%%%%%%%%%solve the equation
 Q = vpasolve([ eq1==0 , eq2==0 , eq3==-2*T , eq4==0 , eq5==4*T , eq6==-4*T , eq7==0 ,eq8==0  ], [C1,C2,C3,C4,C5,C6,C7,C8]);  
